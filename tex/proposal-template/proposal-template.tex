...
LI PS]. In [CITE YANG], SDCA is implemented in a distributed, syncrhonized
...
We will approach this problem from both theoreticl and implementation
...
also add CUDA kernals for portions of our algorithms that are easily
