...
(ADMM), and stochastic dual coordinate ascent (SDCA). The key idea of
distributed SGD is calculating the stochastic gradient at the worker nodes
according to the local information while performing parameter updates at the
master node. On top of this idea, many approaches were
proposed\cite{zinkevich2010parallelized,recht2011hogwild,agarwal2011distributed}.
