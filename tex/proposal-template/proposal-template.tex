...
guarantees regarding the duality gap. T. Yang
\cite{yang2013trading,yang2013analysis} developed two 
...
to SDCA to make full use of computational resources that scales well. 
...
\cite{yang2013trading}, first add GPU capabilities and then incorporating M.
...
operations).  Additionally, \cite{agarwal2011distributed} explores the
